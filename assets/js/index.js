...
function drawWave() {
  ...
  const layers = [
    { freq: 0.012, amp: 0.28, speed: 0.009,  color: '#00e5ff', lineW: 1.5 },
    { freq: 0.018, amp: 0.18, speed: 0.0132, color: '#9b5cf6', lineW: 1 },
    { freq: 0.008, amp: 0.38, speed: 0.0054, color: '#5b8cff', lineW: 0.8 },
  ];
